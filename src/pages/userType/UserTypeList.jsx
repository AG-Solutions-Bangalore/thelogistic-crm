...
const UserTypeList = () => {
    ...
    const formatRoleList = (roles) => {
        ...
        return roles.split(",").map(role => (
            <span key={role} className="inline-block bg-green-100 rounded px-2 py-1 m-1 text-sm">
                {role.trim()}
            </span>
        ));
    };
                                ...
                                {userTypeData.length > 0 ? (
                                    userTypeData.map((user) => (
                                        <React.Fragment key={user.id}>
                                            ...
                                            {expandedRows[`button-${user.id}`] && user.default_button_role && (
                                                <tr>
                                            ...
                                            {expandedRows[`page-${user.id}`] && user.default_page_role && (
                                                <tr>
                                                    <td colSpan="5" className="border p-4 bg-gray-50">
                                    ...
                                    <tr>
                                        <td colSpan="5" className="border p-2 text-center">No data available</td>
                                    </tr>
                                )}
                            </tbody>
                        </table>
